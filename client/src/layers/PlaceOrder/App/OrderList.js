...
import { modifiedError, modifiedStatus, deleteUpdateOrder, listOrderMine, ordersError, ordersState, ordersStatus, resetModified, resetOrders } from '../features/OrderSlice';
...
export default function OrderList(props) {
    ...
    useEffect(() => {
        dispatch(listOrderMine({ admin: true, seller: sellerMode ? user._id : '' }));
        return () => {
    ...
    return status === "idle" ? (
            ...
            <div>
                ...
                {deleteStatus === "failed" && <MessageBox variant="danger">{ deleteError.message }</MessageBox>}
